...
(function() {
    ...
    angular
      .module('app')
      .controller('ToggleSwitchCtrl', ToggleSwitchCtrl );
      
      ToggleSwitchCtrl.$inject = ['$scope', '$window'];

      function ToggleSwitchCtrl($scope, $window){

        angular.element(document).ready(function () {
            
          //Translate checkboxes to Toggle Switches by className
          $(".bs-toggle-switch").bootstrapSwitch();
